...
function suggestionList(type, value, lastText, negatable) {
	...
	if (type == "option") {
		suggestions(value, lastText, "option", "<i class=\"icon normal\">?</i>", out, negatable);
			...
			suggestions(blocks, lastText, "block", "<i class=\"icon normal\">b</i>", out, negatable);
	} else if(type == "block-with-tag") {
			suggestions(blockTags, lastText, "block", "<i class=\"icon normal\">b</i>", out, negatable);
	} else if(type == "effect") {
			suggestions(effects, lastText, "effect", "<i class=\"icon normal\">e</i>", out, negatable);
	} else if(type == "advancement") {
			suggestions(advancements, lastText, "advancement", "<i class=\"icon normal\">a</i>", out, negatable);
	} else if(type == "biome") {
			suggestions(biomes, lastText, "biome", "<i class=\"icon normal\">b</i>", out, negatable);
	} else if(type == "structure") {
			suggestions(structures, lastText, "structure", "<i class=\"icon normal\">st</i>", out, negatable);
	} else if(type == "loottable") {
			suggestions(loottables, lastText, "loottable", "<i class=\"icon normal\">l</i>", out, negatable);
	} else if(type == "sound") {
			suggestions(sounds, lastText, "sound", "<i class=\"icon normal\">s</i>", out, negatable);
	} else if(type == "particle") {
			suggestions(particles, lastText, "particle", "<i class=\"icon normal\">p</i>", out, negatable);
	} else if(type == "enchantment") {
			suggestions(enchantments, lastText, "enchantment", "<i class=\"icon normal\">e</i>", out, negatable);
	} else if(type == "entity-id") {
			suggestions(entities, lastText, "entity-id", "<i class=\"icon normal\">e</i>", out, negatable);
	} else if(type == "entity-with-tag") {
			suggestions(entityTags, lastText, "entity-id", "<i class=\"icon normal\">e</i>", out, negatable);
	} else if(type == "item") {
			suggestions(items, lastText, "item", "<i class=\"icon normal\">i</i>", out, negatable);
	} else if(type == "item-with-tag") {
			suggestions(itemTags, lastText, "item", "<i class=\"icon normal\">i</i>", out, negatable);
	} else if(type == "recipe") {
			suggestions(recipes, lastText, "recipe", "<i class=\"icon normal\">r</i>", out, negatable);
	} else if(type == "color") {
			suggestions(colors, lastText, "recipe", "<i class=\"icon normal\">c</i>", out, negatable);
	}	else if(type == "slot") {
			suggestions(slots, lastText, "slot", "<i class=\"icon normal\">s</i>", out, negatable);
			sort = false;
...
module.exports = {
	...
	onDidInsertSuggestion: function(args) {
		var types = ["block","effect","advancement","loottable","particle","sound","enchantment","entity-id","item","recipe","slot","objective-slot","objective","biome"];
