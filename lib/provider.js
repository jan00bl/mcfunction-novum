...
function suggestionList(type, value, lastText, negatable) {
	...
	if (type == "option") {
		suggestions(value, lastText, "option", "<i class=\"icon normal\">?</i>", out, negatable);
			...
			suggestions(colors, lastText, "color", "<i class=\"icon normal\">c</i>", out, negatable);
	}	else if(type == "attribute") {
			suggestions(attribute, lastText, "attribute-id", "<i class=\"icon normal\">a</i>", out, negatable);
	} else if(type == "slot") {
