...
function onDidInsertSuggestion(args) {
	let types = ["attribute-id", "block", "effect", "advancement", "loottable", "particle", "sound", "enchantment", "entity-id", "entity-selector", "item", "lootItems", "recipe", "slot", "objective-slot", "objective", "biome"];
